...
# find the SFML include directory (first using custom paths, then standards)
...
if(SFML_STATIC_LIBRARIES)
    ...
    macro(find_sfml_dependency output friendlyname)
        ...
        find_library(${output} NAMES ${ARGN} HINTS ${SFML_ROOT} $ENV{SFML_ROOT} PATHS ${FIND_SFML_PATHS} PATH_SUFFIXES lib NO_SYSTEM_ENVIRONMENT_PATH)
...
if(SFML_FOUND AND NOT SFML_FIND_QUIETLY)
    ...
    if(NOT TARGET sfml::system)
        ...
        set_target_properties(sfml::system PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SFML_INCLUDE_DIR}")
        set_target_properties(sfml::system PROPERTIES INTERFACE_LINK_LIBRARIES "${SFML_SYSTEM_DEPENDENCIES}")
        set_target_properties(sfml::system PROPERTIES IMPORTED_LOCATION "${SFML_SYSTEM_LIBRARY}")
    endif()
    if(NOT TARGET sfml::network)
        add_library(sfml::network UNKNOWN IMPORTED)
        set_target_properties(sfml::network PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SFML_INCLUDE_DIR}")
        set_target_properties(sfml::network PROPERTIES INTERFACE_LINK_LIBRARIES "${SFML_NETWORK_DEPENDENCIES}")
        set_target_properties(sfml::network PROPERTIES IMPORTED_LOCATION "${SFML_NETWORK_LIBRARY}")
    ...
    if(NOT TARGET sfml::window)
        ...
        set_target_properties(sfml::window PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SFML_INCLUDE_DIR}")
        set_target_properties(sfml::window PROPERTIES INTERFACE_LINK_LIBRARIES "${SFML_WINDOW_DEPENDENCIES}")
    ...
    if(NOT TARGET sfml::audio)
        ...
        set_target_properties(sfml::audio PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SFML_INCLUDE_DIR}")
        set_target_properties(sfml::audio PROPERTIES INTERFACE_LINK_LIBRARIES "${SFML_AUDIO_DEPENDENCIES}")
        set_target_properties(sfml::audio PROPERTIES IMPORTED_LOCATION "${SFML_AUDIO_LIBRARY}")
        target_link_libraries(sfml::audio INTERFACE sfml::system)
    endif()
    if(NOT TARGET sfml::graphics)
        add_library(sfml::graphics UNKNOWN IMPORTED)
        set_target_properties(sfml::graphics PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SFML_INCLUDE_DIR}")
        set_target_properties(sfml::graphics PROPERTIES INTERFACE_LINK_LIBRARIES "${SFML_GRAPHICS_DEPENDENCIES}")
        ...
        target_link_libraries(sfml::graphics INTERFACE sfml::system)
    endif()
endif()
