...
if(UNIX AND NOT LXGUI_EMSCRIPTEN)
...
if(LXGUI_FOUND)
    if(LXGUI_GUI_GL_LIBRARY)
        if(NOT LXGUI_EMSCRIPTEN)
            ...
            set(LXGUI_GUI_GL_LIBRARIES_EMSCRIPTEN "-s USE_SDL=2 -s USE_LIBPNG=1 -s USE_FREETYPE=1 -s MIN_WEBGL_VERSION=3")
            mark_as_advanced(LXGUI_GUI_GL_INCLUDE_DIRS LXGUI_GUI_GL_LIBRARIES)
        endif()
    endif()
    ...
    if(LXGUI_GUI_SDL_LIBRARY)
        if(NOT LXGUI_EMSCRIPTEN)
            ...
            set(LXGUI_GUI_SDL_LIBRARIES_EMSCRIPTEN "-s USE_SDL=2 -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS='[\"png\"]' -s USE_SDL_TTF=2 -s MIN_WEBGL_VERSION=2")
        endif()
    endif()
