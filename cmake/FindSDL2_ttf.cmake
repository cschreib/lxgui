...
if (SDL2_TTF_FOUND)
  if(NOT TARGET SDL2::TTF)
      ...
      set_target_properties(SDL2::TTF PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SDL2_TTF_INCLUDE_DIRS}")
      set_target_properties(SDL2::TTF PROPERTIES INTERFACE_LINK_LIBRARIES "${SDL2_TTF_LIBRARIES}")
      set_target_properties(SDL2::TTF PROPERTIES IMPORTED_LOCATION "${SDL2_TTF_LIBRARY}")
  endif()
endif()
