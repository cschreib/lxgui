...
if (SDL2_IMAGE_FOUND)
  if(NOT TARGET SDL2::image)
      ...
      set_target_properties(SDL2::image PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${SDL2_IMAGE_INCLUDE_DIRS}")
      set_target_properties(SDL2::image PROPERTIES INTERFACE_LINK_LIBRARIES "${SDL2_IMAGE_LIBRARIES}")
      set_target_properties(SDL2::image PROPERTIES IMPORTED_LOCATION "${SDL2_IMAGE_LIBRARY}")
  endif()
endif()
