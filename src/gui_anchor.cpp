...
vector2f anchor::get_point(const region& mObject) const {
    ...
    case anchor_point::TOP:
        ...
        mParentOffset.y = 0.0f;
        break;
    case anchor_point::CENTER: mParentOffset = mParentSize / 2.0f; break;
