...
struct standard_dereferencer {
    ...
    static data_type dereference(const BaseIterator& mIter) {
        return *mIter;
    }
};
...
struct non_null_filter {
    static bool is_included(const BaseIterator& mIter) {
...
public:
    ...
    adaptor& operator=(const adaptor& mOther) {
        mCollection_ = mOther.mCollection_;
        return *this;
    }
    adaptor& operator=(adaptor&& mOther) {
        mCollection_ = mOther.mCollection_;
        return *this;
    }
    ...
    public:
        ...
        iterator& operator++() {
            do {
                ++mIter_;
            } while (mIter_ != mAdaptor_.mCollection_.end() &&
                     !mAdaptor_.mFilter_.is_included(mIter_));
        ...
        bool operator==(const iterator& mOther) const {
            return mIter_ == mOther.mIter_;
        }
        bool operator!=(const iterator& mOther) const {
            return mIter_ != mOther.mIter_;
        }
        ...
        data_type operator*() const {
            return mAdaptor_.mDeref_.dereference(mIter_);
        }
        data_type operator->() const {
            return mAdaptor_.mDeref_.dereference(mIter_);
        }
