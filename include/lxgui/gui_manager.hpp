...
namespace gui
{
    ...
    private :
        ...
        template <class T>
        static oup::observable_unique_ptr<frame> create_new_frame(manager* pMgr)
        {
            return oup::make_observable_unique<T>(pMgr);
        }

        template <class T>
        static oup::observable_unique_ptr<layered_region> create_new_layered_region(manager* pMgr)
        {
            return oup::make_observable_unique<T>(pMgr);
        }
    ...
    public :
        ...
        */
        using root_frame_list = std::list<oup::observable_unique_ptr<frame>>;
        ...
        *         region objects.
        */
        oup::observable_unique_ptr<uiobject> create_uiobject(const std::string& sClassName);
        ...
        */
        oup::observable_unique_ptr<frame> create_frame(const std::string& sClassName);
        ...
        *         region object.
        */
        oup::observable_unique_ptr<layered_region> create_layered_region(const std::string& sClassName);
        ...
        */
        frame* add_root_frame(oup::observable_unique_ptr<frame> pFrame);
        ...
        */
        oup::observable_unique_ptr<frame> remove_root_frame(frame* pFrame);
        ...
        *                           a oup::observable_unique_ptr<frame>.
        *   \note Set the first template argument as the C++ type of this frame.
        */
        ...
        *                           return a oup::observable_unique_ptr<layered_region>.
        *   \note Set the first template argument as the C++ type of this layered_region.
        */
    ...
    private :
        ...
        string_map<std::function<oup::observable_unique_ptr<frame>(manager*)>>          lCustomFrameList_;
        string_map<std::function<oup::observable_unique_ptr<layered_region>(manager*)>> lCustomRegionList_;
