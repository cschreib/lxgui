...
namespace gui
{
    ...
    */
    ...
    public :
        ...
        */
        using child_list = std::list<oup::observable_unique_ptr<frame>>;
        ...
        *          - ordering of elements is irrelevant
        */
        using region_list = std::list<oup::observable_unique_ptr<layered_region>>;
        ...
        */
        layered_region* add_region(oup::observable_unique_ptr<layered_region> pRegion);
        ...
        */
        ...
        region_type* add_region(oup::observable_unique_ptr<region_type> pRegion)
        {
            return static_cast<region_type*>(add_region(
                oup::observable_unique_ptr<layered_region>(std::move(pRegion), pRegion.get())));
        }
        ...
        */
        oup::observable_unique_ptr<layered_region> remove_region(layered_region* pRegion);
        ...
        */
        frame* add_child(oup::observable_unique_ptr<frame> pChild);

        /// Adds a frame to this frame's children.
        /** \param pChild The frame to add
        */
        template<typename frame_type, typename enable = typename std::enable_if<std::is_base_of<gui::frame, frame_type>::value>::type>
        frame_type* add_child(oup::observable_unique_ptr<frame_type> pChild)
        {
            return static_cast<frame_type*>(add_child(
                oup::observable_unique_ptr<frame>(std::move(pChild), pChild.get())));
        }
        ...
        */
        oup::observable_unique_ptr<frame> remove_child(frame* pChild);
