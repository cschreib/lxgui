...
namespace gui
{
    ...
    */
    ...
    protected :
        ...
        oup::observable_unique_ptr<texture>     create_normal_texture_();
        oup::observable_unique_ptr<texture>     create_pushed_texture_();
        oup::observable_unique_ptr<texture>     create_disabled_texture_();
        oup::observable_unique_ptr<texture>     create_highlight_texture_();
        oup::observable_unique_ptr<font_string> create_normal_text_();
        oup::observable_unique_ptr<font_string> create_highlight_text_();
        oup::observable_unique_ptr<font_string> create_disabled_text_();
