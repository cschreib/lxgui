...
utils::observable_sealed_ptr<uiobject> manager::create_uiobject(const std::string& sClassName)
{
    if (sClassName == "Frame")
        return utils::make_observable_sealed<frame>(this);
    else if (sClassName == "FocusFrame")
        return utils::make_observable_sealed<focus_frame>(this);
    else
    {
...
utils::observable_sealed_ptr<frame> manager::create_frame(const std::string& sClassName)
{
    if (sClassName == "Frame")
        return utils::make_observable_sealed<frame>(this);
    else if (sClassName == "FocusFrame")
...
utils::observable_sealed_ptr<layered_region> manager::create_layered_region(const std::string& sClassName)
{
    auto iterRegion = lCustomRegionList_.find(sClassName);
    if (iterRegion != lCustomRegionList_.end())
        return iterRegion->second(this);
...
frame* manager::add_root_frame(utils::observable_sealed_ptr<frame> pFrame)
{
...
utils::observable_sealed_ptr<frame> manager::remove_root_frame(frame* pFrame)
{
